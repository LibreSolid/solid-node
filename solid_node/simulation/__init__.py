...
_EXPORTS = {
    ...
    'Sim': 'sim',
    # The running mode's error kinds, and the entry its crossing
    # record is made of. Lazy like every export here, and for one more
    # reason: naming any of them imports the running engine, which a
