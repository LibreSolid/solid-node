...
- FROM: `### Requirement: Each end of a relation resolves to one coordinate`
- TO: `### Requirement: Each end of a relation resolves to a coordinate, or to one per copy of a repeated child`
