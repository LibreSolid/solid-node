...
- [ ] 1.1 Study `tests/test_assembly_integrity.py` and its
      ...
      assembly variant.
- [ ] 1.2 Write `tests/test_assembly_supported.py` covering every delta-spec
...
- [ ] 2.1 Add private support-graph helpers to `solid_node/test.py`:
...
- [ ] 2.2 Add `TestCase.assertAssemblySupported(node, gravity=(0, 0, -1),
...
- [ ] 2.3 Turn the whole new suite green; run the existing framework test
...
- [ ] 3.1 Document the assertion in `docs/testing.rst` beside
