...
evaluation, or animation clock. It SHALL preserve the maker's viewpoint through
the mount handle on reload, name the tab after the model, and show build errors
or the missing-bundle remedy in its error pane.
